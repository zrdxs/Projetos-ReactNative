...
export default props => {
    ...
    //riscando o texto caso a tarefa esteja concluida
    //CSS
    const descStyle = props.doneAt !== null ?
        {textDecorationLine: 'line-through'} : {}

    //definindo o compotamento dos lados do swipe, buttons e etc
    const leftContent = (
    ...
    return(
        //o Swipeable só possui evento no lado esquerdo pois ele deleta sem confirmação
        //já o rightButtons precisa mostras os botoes, então o evento fica na rightContent
